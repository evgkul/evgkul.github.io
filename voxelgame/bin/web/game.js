...
function jsbind0(a0,a1){ loadGameAsset(Module,UTF8ToString(a0),a1);}
function jsbind1(){Module.requestFullscreen(1,1)}
function jsbind2(){document.exitFullscreen()}
...
var _emAssetAllocSpace = Module["_emAssetAllocSpace"] = function() {
  return (_emAssetAllocSpace = Module["_emAssetAllocSpace"] = Module["asm"]["emAssetAllocSpace"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _emAssetFinished = Module["_emAssetFinished"] = function() {
  return (_emAssetFinished = Module["_emAssetFinished"] = Module["asm"]["emAssetFinished"]).apply(null, arguments);
};
